...
import com.phonyx.commons.databinding.ItemBreadcrumbBinding
import com.phonyx.commons.databinding.ItemBreadcrumbFirstBinding
...
class Breadcrumbs(context: Context, attrs: AttributeSet) : HorizontalScrollView(context, attrs) {
    ...
    private fun addBreadcrumb(item: FileDirItem, index: Int, addPrefix: Boolean) {
        if (itemsLayout.childCount == 0) {
            val firstItemBgColor = resources.getColor(R.color.you_dialog_background_color, context.theme)

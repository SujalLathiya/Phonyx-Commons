...
object MyContentProvider {
    private const val AUTHORITY = "com.phonyx.android.provider"
    val MY_CONTENT_URI: Uri = Uri.parse("content://$AUTHORITY/settings")

    const val ACTION_GLOBAL_CONFIG_UPDATED = "com.phonyx.android.GLOBAL_CONFIG_UPDATED"
    const val PERMISSION_WRITE_GLOBAL_SETTINGS = "com.phonyx.android.permission.WRITE_GLOBAL_SETTINGS"

    const val COL_ID = "_id"    // used in Phonyx Thank You

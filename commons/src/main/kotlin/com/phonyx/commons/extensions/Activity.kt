...
import com.phonyx.commons.databinding.DialogTitleBinding
import com.phonyx.commons.dialogs.*
import com.phonyx.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.phonyx.commons.helpers.*
import com.phonyx.commons.helpers.MyContentProvider.COL_LAST_UPDATED_TS
import com.phonyx.commons.helpers.MyContentProvider.MY_CONTENT_URI
import com.phonyx.commons.models.AlarmSound
import com.phonyx.commons.models.Android30RenameFormat
import com.phonyx.commons.models.FileDirItem
import com.phonyx.commons.models.RadioItem
import com.phonyx.commons.views.MyTextView
import java.io.*
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.phonyx.gallery" || applicationId == "com.phonyx.gallery.debug") {

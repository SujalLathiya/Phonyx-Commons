...
import com.phonyx.commons.adapters.ManageBlockedNumbersAdapter
import com.phonyx.commons.databinding.ActivityManageBlockedNumbersBinding
import com.phonyx.commons.dialogs.AddBlockedNumberDialog
import com.phonyx.commons.dialogs.ExportBlockedNumbersDialog
import com.phonyx.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity(), RefreshRecyclerViewListener {
    ...
    private fun setupBlockUnknown() {
        val blockUnknownTitleRes =  R.string.block_unknown_calls

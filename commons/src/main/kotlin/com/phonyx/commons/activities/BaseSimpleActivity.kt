package com.phonyx.commons.activities
...
import com.phonyx.commons.asynctasks.CopyMoveTask
...
import com.phonyx.commons.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        val backgroundColor = resources.getColor(R.color.you_background_color, theme)
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.phonyx.")
